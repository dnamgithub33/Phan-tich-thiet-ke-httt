                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <div class="form-outline">
                                                    ...
                                                    <input type="text" name="citizenIdentification" class="form-control form-control-lg" required/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4 d-flex align-items-center">
                                                ...
                                                <div class="form-outline datepicker w-100">
                                                    ...
                                                    <input type="date" class="form-control form-control-lg" name="birth" required />
